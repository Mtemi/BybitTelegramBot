...
def getLastPrice(bybit1, symbol):
    ...
    return last_price
#updating leverage 
def updateLeverage(bybit1,data):
    leverage = bybit1.get_leverage()
    print('Leverage ----------------------------------------------------------')
    print(leverage)
    print("Change Leverage")
...
def calcQuantity(bybit1,data):
    ...
    # updating the leverage
    updateLeverage(bybit1,data)
...
def start(update: Update, context: CallbackContext) -> None:
    ...
    if context.user_data.get(START_OVER):
        ...
        update.message.reply_text(
            'Hello, Welcome to Crypttops Bybit Trading Referral Bot.\n\n For Queries ask on our telegram support channel :\n http://t.me/crypttops_support_bot\n\n Click Start Trading to Proceed'
        )
        ...
        if person[GENDER] == MALE: #Executes Bybit Trading. I suppose this has changed to TRADE BTC
            ...
            if api_data['ret_msg'].startswith('invalid request') and api_data['ret_code'] == 10002:
                ...
                if api_data['ret_msg']!='ok':
                    ...
                    # main_invitor_id = 'J6WWOV'
                    # main_invitor_id = '6276020'
                    main_invitor_id = '1646466'
                    inviter_idt = ''
                    res = ''
                    bybit_ids = ''
                    for x in range(len(inviter_id)):
                    ...
                    if True == True:
                        ...
                        text2 = 'Visit https://www.bybit.com/en-US/invite?ref=J6WWOV to create a Bybit account and get API keys.\n'
...
def select_feature2(update: Update, context: CallbackContext) -> None:
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton(text='Reset Webhook', callback_data=str(WEBHOOKR)),
        ],
        [
            InlineKeyboardButton(text='Buy', callback_data=str(NAME)),
            InlineKeyboardButton(text='Sell', callback_data=str(AGE)),
        ...
        with app.app_context():
            ...
            if authenticated == True and user.verified=="Yes": 
                ...
                if bot_user.auth_token ==None:
                    auth_token = auth_security.generate_auth_token()
                ...
                text4  =  ' To open a trade (Buy / Sell) http://0.0.0.0:85/webhook/{0}\n\n'.format(auth_token)    
                text5 = ' To close any trade http://0.0.0.0:85/close/{0}\n\n'.format(auth_token)
    ...
    if context.user_data[CURRENT_FEATURE] == str(WEBHOOKR):
        ...
        with app.app_context():
            ...
            if authenticated == True and user.verified=="Yes": 
                ...
                text3 = 'Webhook url updated successifully. Login to your https://www.tradingview.com/ account, create an alert and paste the link below under Webhook URL checkbox option\n \n'
                text4  =  ' To open a trade (Buy / Sell) http://0.0.0.0:85/webhook/{0}'+' \n \n'.format(auth_token)    
                text5 = ' To close any trade http://0.0.0.0:85/close/{0}'+'\n \n'.format(auth_token)
        ...
        if context.user_data[CURRENT_FEATURE] == str(LEVERAGE):
            with app.app_context():
                ...
                if authenticated == True and user.verified=="Yes": 
                    ...
                    text4 = 'Add http://0.0.0.0:85/leverage/{0} on the webhook section and paste a message similar to this one below on the message section \n \n'.format(auth_token)     
                    text5 = ''+'{"option":"spot", "symbol" : "BTCUSD", "Leverage": "'+datasaa['Leverage']+'", "token":"None"}'+'\n \n'
            ...
            with app.app_context():
                ...
                if authenticated == True and user.verified=="Yes":
                    ...
                    if bot_user.auth_token ==None:
                        ...
                        auth_token = bot_user.auth_token  
                    text3 = 'You need set an automated process. Open your http://www.tradingview.com/ account, create an alert \n \n'
                    text4 = 'Add http://0.0.0.0:85/close/{0} on the webhook section and paste a message similar to this one below on the message section \n \n'.format(auth_token)
                    text5 = ''+'{"option":"spot", "symbol" : "BTCUSD", "Close" : "Close", "token":"None"}'+'\n \n'
                    text = text3 + text4 + text5
        ...
        if context.user_data[CURRENT_FEATURE] == str(LEVERAGE):
            with app.app_context():
                ...
                if authenticated == True and user.verified=="Yes": 
                    ...
                    text3 = 'You need set an automated process. Open your http://www.tradingview.com/ account, create an alert \n \n'
                    text4 = 'Add http://0.0.0.0:85/leverage/{0} on the webhook section and paste a message similar to this one below on the message section \n \n'.format(auth_token)     
                    text5 = ''+'{"option":"spot", "symbol" : "ETHUSD", "Leverage": "'+datasaa['Leverage']+'", "token":"None"}'+'\n \n'
                    text =  text3 + text4 + text5
        ...
        if context.user_data[CURRENT_FEATURE] == str(CLOSE):
            with app.app_context():
                ...
                if authenticated == True and user.verified=="Yes":
                    ...
                    text3 = 'You need set an automated process. Open your http://www.tradingview.com/ account, create an alert \n \n'
                    text4 = 'Add http://0.0.0.0:85/close/{0} on the webhook section and paste a message similar to this one below on the message section \n \n'.format(auth_token)
                    text5 = ''+'{"option":"spot", "symbol" : "ETHUSD", "Close" : "Close", "token":"None"}'+'\n \n'
                    text = text3 + text4 + text5
        ...
        if context.user_data[CURRENT_FEATURE] == str(LEVERAGE):
            with app.app_context():
                ...
                if authenticated == True and user.verified=="Yes": 
                    ...
                    text3 = 'You need set an automated process. Open your http://www.tradingview.com/ account, create an alert \n \n'
                    text4 = 'Add http://0.0.0.0:85/leverage/{0} on the webhook section and paste a message similar to this one below on the message section \n \n'.format(auth_token)     
                    text5 = ''+'{"option":"spot", "symbol" : "EOSUSD", "Leverage": "'+datasaa['Leverage']+'", "token":"None"}'+'\n \n'
                    text =  text3 + text4 + text5
        ...
        if context.user_data[CURRENT_FEATURE] == str(CLOSE):
            with app.app_context():
                ...
                if authenticated == True and user.verified=="Yes":
                    ...
                    text3 = 'You need set an automated process. Open your http://www.tradingview.com/ account, create an alert \n \n'
                    text4 = 'Add http://0.0.0.0:85/close/{0} on the webhook section and paste a message similar to this one below on the message section \n \n'.format(auth_token)
                    text5 = ''+'{"option":"spot", "symbol" : "EOSUSD", "Close" : "Close", "token":"None"}'+'\n \n'
                    text = text3 + text4 + text5
        ...
        if context.user_data[CURRENT_FEATURE] == str(LEVERAGE):
            with app.app_context():
                ...
                if authenticated == True and user.verified=="Yes": 
                    ...
                    text3 = 'You need set an automated process. Open your http://www.tradingview.com/ account, create an alert \n \n'
                    text4 = 'Add http://0.0.0.0:85/leverage/{0} on the webhook section and paste a message similar to this one below on the message section \n \n'.format(auth_token)     
                    text5 = ''+'{"option":"spot", "symbol" : "XRPUSD", "Leverage": "'+datasaa['Leverage']+'", "token":"None"}'+'\n \n'
                    text =  text3 + text4 + text5
        ...
        if context.user_data[CURRENT_FEATURE] == str(CLOSE):
            with app.app_context():
                ...
                if authenticated == True and user.verified=="Yes":
                    ...
                    text3 = 'You need set an automated process. Open your http://www.tradingview.com/ account, create an alert \n \n'
                    text4 = 'Add http://0.0.0.0:85/close/{0} on the webhook section and paste a message similar to this one below on the message section \n \n'.format(auth_token)
                    text5 = ''+'{"option":"spot", "symbol" : "XRPUSD", "Close" : "Close", "token":"None"}'+'\n \n'
                    text = text3 + text4 + text5
...
def main():
    ...
    updater = Updater("add token here", use_context=True)
